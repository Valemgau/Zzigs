      ...
      try {
        ...
        if (newStatus === "confirmed") {
          msgClient = {
            ...
            desc: `Le couturier a accepté votre proposition de rendez-vous pour "${
          ...
          msgClient = {
            ...
            desc: `Le couturier a refusé votre proposition de rendez-vous pour "${
              offer.project.title || "le projet"
            }".`,
          ...
          msgClient = {
            ...
            desc: `Le couturier a terminé la mission pour "${
              offer.project.title || "le projet"
        ...
        const statusMessages = {
          ...
          refused: "RDV refusé",
          waitPayment: "Mission marquée terminée",
        };

        showMessage({
          message: statusMessages[newStatus] || "RDV mis à jour",
          description:
            newStatus === "confirmed"
  ...
  const handleCancelAppointment = async () => {
    ...
    try {
      ...
      const msgClient = {
        ...
        desc: `Le couturier a annulé le rendez-vous pour "${
          offer?.project.title || "le projet"
      ...
      showMessage({
        ...
        description: "Le client a été informé de l'annulation",
        type: "success",
      });
              ...
              {appointment.status === "pending" && (
                <View className="bg-blue-50 border-l-4 border-blue-500 p-4 mb-3">
                  ...
                  <Text
                    ...
                    style={{ fontFamily: "OpenSans_400Regular" }}
                  >
                    Le client vous propose ce créneau. Acceptez ou refusez.
                  </Text>
              ...
              {appointment.status === "confirmed" && (
                <View className="bg-green-50 border-l-4 border-green-500 p-4 mb-3">
                  ...
                  <Text
                    ...
                    style={{ fontFamily: "OpenSans_400Regular" }}
                  >
                    Rendez-vous confirmé ! Consultez l'adresse ci-dessus.
                    Marquez la mission terminée une fois finie.
                  </Text>
                  <Pressable
                    className="py-3 mb-2"
                    style={{ backgroundColor: COLORS.primary }}
              ...
              {appointment.status === "inProgress" && (
                <View className="bg-orange-50 border-l-4 border-orange-500 p-4 mb-3">
                  ...
                  <Text
                    ...
                    style={{ fontFamily: "OpenSans_400Regular" }}
                  >
                    Travaillez sur le projet du client. Marquez comme terminé
                    une fois fini.
                  </Text>
                  <Pressable
                    className="py-3"
              ...
              {appointment.status === "waitPayment" && (
                <View className="bg-purple-50 border-l-4 border-purple-500 p-4 mb-3">
                  ...
                  <Text
                    ...
                    style={{ fontFamily: "OpenSans_400Regular" }}
                  >
                    Mission terminée ! Le client doit maintenant effectuer le
                    paiement de {item.price}€. Vous serez notifié.
                  </Text>
                </View>
              )}
              ...
              {appointment.status === "paymentConfirmed" && (
                <View className="bg-green-50 border-l-4 border-green-500 p-4 mb-3">
                  ...
                  <Text
                    ...
                    style={{ fontFamily: "OpenSans_400Regular" }}
                  >
                    Mission terminée avec succès ! Le paiement de {item.price}€
                    a été effectué.
                  </Text>
                </View>
              )}
              ...
              {appointment.status === "refused" && (
                <View className="bg-red-50 border-l-4 border-red-500 p-4 mb-3">
                  ...
                  <Text
                    ...
                    style={{ fontFamily: "OpenSans_400Regular" }}
                  >
                    Vous avez refusé ce créneau proposé par le client.
                  </Text>
                </View>
              )}
          ...
          >
            <View className="bg-white p-6">
              ...
              <TextInput
                ...
                placeholder="Ex: Indisponibilité, problème personnel..."
