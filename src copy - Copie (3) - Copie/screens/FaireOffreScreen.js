...
export default function FaireOffreScreen() {
  ...
  }, [navigation, price, message, isSubmitting]);

  useEffect(() => {
    // Auto-focus sur le champ prix
  ...
  useEffect(() => {
    // Animation de pulsation quand le prix est vide
    if (!price) {
      Animated.loop(
        Animated.sequence([
  ...
  const handleSubmit = async () => {
    if (!price) {
      showMessage({
        message: "Prix requis",
        description: "Veuillez entrer un montant pour votre offre.",
        type: "warning",
        icon: "warning",
        duration: 3000,
      });
    ...
    if (!message.trim()) {
      showMessage({
        ...
        description: "Veuillez décrire votre offre et vos compétences.",
        type: "warning",
        icon: "warning",
        duration: 3000,
      });
    ...
    if (message.trim().length < 20) {
      showMessage({
        ...
        description: "Décrivez votre offre plus en détail (minimum 20 caractères).",
        type: "warning",
        icon: "warning",
        duration: 3000,
      });
    ...
    try {
      ...
      // Récupérer les infos de l'auteur du projet pour la notification
      try {
      ...
      showMessage({
        ...
        description: "Le créateur du projet sera notifié.",
        type: "success",
        icon: "success",
        duration: 3000,
      });
  ...
  const sendPushNotification = async (expoPushToken, offerPrice) => {
    const message = {
      ...
      body: `Quelqu'un vous a fait une offre de ${offerPrice}€ sur votre projet.`,
      data: { 
        type: "new_offer",
      ...
      >
        ...
        >
          ...
          <View className="items-center mb-8 mt-4">
            ...
            >
              Proposez votre meilleur prix pour ce projet
            </Text>
          </View>

          {/* Champ Prix - Style Revolut */}
          <Animated.View 
            style={{ 
          ...
          >
            <View className="px-6 py-5">
              ...
              <TextInput
                ...
                placeholder="Décrivez votre offre, vos compétences et pourquoi vous êtes le bon choix pour ce projet..."
                multiline
                maxLength={400}
          ...
          <View className="bg-blue-50 rounded-2xl p-4 mb-6 flex-row">
            ...
            <View className="flex-1">
              ...
              >
                Rédigez un message détaillé pour augmenter vos chances d'être sélectionné (minimum 20 caractères).
              </Text>
            </View>
          </View>

          {/* Bouton principal - Style premium */}
          <Pressable
            onPress={handleSubmit}
