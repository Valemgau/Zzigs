...
const SUBJECTS = [
  { id: 1, label: "Demande générale", icon: "info" },
  { id: 2, label: "Problème technique", icon: "bug-report" },
  { id: 3, label: "Suggestion", icon: "lightbulb" },
  { id: 4, label: "Question", icon: "help" },
...
export default function ContactUs({ navigation }) {
  ...
  const isFormValid = () => {
    const hasSubject = subject && (subject !== "Autre" || customSubject.trim());
        ...
        >
          <View className="px-5 pt-6 pb-32">
            ...
            >
              ...
              >
                Dites-nous tout ! Notre équipe vous répondra dans les plus brefs
                délais
              </Text>
            </Animated.View>

            {/* Email utilisateur (affichage uniquement) */}
            {userEmail && (
              <Animated.View
              ...
              >
                ...
                <View className="space-y-1">
                  ...
                  >
                    ...
                    {subject === "Autre" ? customSubject : subject}
                  </Text>
                </View>
              </Animated.View>
            )}
