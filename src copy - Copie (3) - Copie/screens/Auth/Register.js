...
export default function Register() {
  ...
  const [selectedRole, setSelectedRole] = useState("couturier"); // couturier ou demandeur
      ...
      >
        <View className="flex-1 px-6 pt-12">
          ...
          <Animated.View entering={FadeInDown.duration(300)} className="mb-10">
            ...
            >
              {i18n.t("creer_un_compte") || "Créer un compte"}
            </Text>
            <Text
              className="text-base text-gray-600"
              style={{ fontFamily: "OpenSans_400Regular" }}
            >
              {i18n.t("entrez_vos_informations_pour_inscription") ||
          ...
          >
            ...
            <View className="flex-row gap-3">
              ...
              >
                ...
                >
                  {i18n.t("Je suis un couturier") || "Couturier"}
                </Text>
              </Pressable>
              ...
              >
                ...
                >
                  {i18n.t("Je suis un demandeur") || "Demandeur"}
                </Text>
              </Pressable>
            </View>
          </Animated.View>
          ...
          >
            <Text
              ...
              style={{ fontFamily: "OpenSans_600SemiBold" }}
            >
              {i18n.t("password_confirm") || "Confirmer le mot de passe"}
            </Text>
            <View className="relative">
              <View className="absolute left-4 top-3 z-10">
                <MaterialIcons name="lock" size={20} color="#6B7280" />
              ...
              {loading ? (
                ...
                <View className="flex-row items-center">
                  ...
                  <Text
                    ...
                    style={{ fontFamily: "OpenSans_700Bold" }}
                  >
                    {i18n.t("creer_compte") || "Créer mon compte"}
                  </Text>
                </View>
              )}
            </Pressable>
