  ...
  const handleManualSave = async () => {
    if (!fields.address.trim() || !fields.postalCode.trim() || !fields.city.trim()) {
      showMessage({
        ...
        description: "Veuillez remplir au moins l'adresse, le code postal et la ville",
        type: "warning",
        icon: "warning",
      });
      return;
      ...
      >
        ...
        >
          <View className="px-5 pt-6 pb-32">
            {/* Info Header - Version minimaliste */}
            <Animated.View
            ...
            >
              ...
              >
                Votre adresse permet de calculer les distances avec les projets disponibles
              </Text>
            </Animated.View>
