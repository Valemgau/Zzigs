          ...
          >
            <View className="flex-row gap-3">
              <Pressable
                ...
                style={{
                  backgroundColor:
                    selectedRole === "couturier" ? "#fff" : "rgba(255,255,255,0.1)",
                  borderColor:
                    selectedRole === "couturier" ? "#fff" : "rgba(255,255,255,0.3)",
                }}
              >
                <MaterialIcons
                  name="content-cut"
                  size={20}
                  color={selectedRole === "couturier" ? COLORS.primary : "#fff"}
                />
                <Text
              ...
              <Pressable
                ...
                style={{
                  backgroundColor:
                    selectedRole === "demandeur" ? "#fff" : "rgba(255,255,255,0.1)",
                  borderColor:
                    selectedRole === "demandeur" ? "#fff" : "rgba(255,255,255,0.3)",
                }}
              >
                <MaterialIcons
                  name="person"
                  size={20}
                  color={selectedRole === "demandeur" ? COLORS.primary : "#fff"}
                />
                <Text
                  className="text-xs font-bold mt-1"
                  style={{
